...
function setDefaultOpts (opts) {
  ...
  if (!isBrowser(opts) && opts.protocol === 'wss') {
...
function serverStreamBuilder (client, opts) {
  debug('streamBuilder')
  let options = setDefaultOpts(opts)
...
function streamBuilder (client, opts) {
  if (isBrowser(opts)) {
    return browserStreamBuilder(client, opts)
  }
  return serverStreamBuilder(client, opts)
}
